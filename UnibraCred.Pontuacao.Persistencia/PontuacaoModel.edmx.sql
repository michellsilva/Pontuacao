...
-- --------------------------------------------------
-- Date Created: 01/23/2016 14:14:17
-- Generated from EDMX file: C:\Users\Lenovo\Documents\Pos Engenharia Software\Pontuacao\trunk\UnibraCred.Pontuacao\UnibraCred.Pontuacao.Persistencia\PontuacaoModel.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[PontuacaoSet] (
    ...
    [CartaoId] nvarchar(max)  NOT NULL,
    [Validade] datetime  NOT NULL,
    [FaturaValor] decimal(18,0)  NOT NULL,
